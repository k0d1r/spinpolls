...
async function testAndFixFirestore() {
  try {
    ...
    console.log('4. Mevcut rules\'ları silin ve şunu yapıştırın:');
    console.log('');
    ...
    console.log('2. URGENT_FIX.md dosyasındaki rules\'ları kullanın');
  }
}
